    ...
    return (
        <footer className="container mx-auto py-6 mb-14  md:mb-0">
            ...
            <div className="flex justify-between items-center p-5">
                ...
                <button 
                    onClick={toggleTheme} 
                    className={`text-xl md:text-4xl p-2 transition-colors duration-30 rounded-xl border-2 border-sky-500 ${isDarkTheme ? 'bg-black text-white' : 'bg-white text-black'}`} 
